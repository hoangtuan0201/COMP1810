...
data$Sessions <- as.numeric(gsub(",", "", data$Sessions))
...
ggplot(data = device_summary, 
       aes(x = factor(Source...Medium), y = total_users, )) +
  geom_bar(stat = "identity", position = "dodge",  fill = "#1f78b4") +
...
ggplot(data = device_summary, 
       aes(x = factor(Source...Medium), y = total_new_users, )) +
  geom_bar(stat = "identity", position = "dodge",  fill = "#1f78b4") +
